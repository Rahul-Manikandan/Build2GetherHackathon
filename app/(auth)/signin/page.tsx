...
export default function SignIn() {
    ...
    return (
        <div ref={container} className="flex flex-col min-h-screen bg-[#F8FAFF] relative overflow-hidden font-sans">
            {/* Geometric Decoration (Matches Landing Page) */}
            <div className="absolute top-[-10%] right-[-10%] w-[60%] aspect-square opacity-[0.03] pointer-events-none">
            ...
            <main className="flex-1 flex items-center justify-center p-6 z-10">
                <div className="w-full max-w-md space-y-10">
                    <div className="auth-header text-center space-y-3">
                        ...
                        <p className="text-slate-400 font-medium">Verify your credentials to continue</p>
                    </div>
                    ...
                    <div className="auth-card bg-white/80 backdrop-blur-xl p-6 sm:p-8 rounded-[2.5rem] sm:rounded-[3rem] border border-white shadow-2xl shadow-slate-200/50 relative">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 ml-4">Email Workspace</label>
                                <Input
                                    type="email"
                            ...
                            {error && (
                                <p className="text-xs font-bold text-red-500 bg-red-50 p-4 rounded-2xl border border-red-100 animate-in fade-in slide-in-from-top-1">
                                    {error}
                                </p>
                            )}
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-bold">
                                        <span className="bg-[#F8FAFF] px-4 text-slate-300">Or continue with</span>
                                    </div>
                                </div>
                    ...
                    <p className="auth-footer text-center text-sm font-bold text-slate-400">
                        New member? <Link href="/signup" className="text-primary hover:text-primary/80 transition-colors uppercase tracking-widest text-xs ml-2">Register Here</Link>
                    </p>
                </div>
            </main>
        </div>
